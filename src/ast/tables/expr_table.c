...
state_table* get_expr_table(void){
    ...
    static state_table expr_table = {
        ...
        {N,         N,      R(0,0), S(3),   R(0,0), N,      N,      N,          SNA(18),    R(0,0),     R(0,0),     N},             //STATE 6: expr +- ID
        {N,         N,      R(0,0), R(0,0), R(0,0), N,      N,      N,          SNA(18),    R(0,0),     R(0,0),     N},             //STATE 7: expr */ ID
        ...
        {N,         N,      S(2),   S(3),   R(1,16),S(8),   N,      R(1,16),    N,          R(1,16),    N,          N},             //STATE 14: expr , var/expr     [expr expr]
        {N,         N,      S(2),   S(3),   R(1,16),N,      S(10),  R(1,16),    SNA(18),    R(1,16),    N,          N},             //STATE 15: expr , ID
        {N,         N,      N,      N,      A,      N,      N,      13,         N,          C,          N,          N},             //STATE 16: tuple
        ...
        {N,         N,      S(2),   S(3),   R(0,0), S(8),   N,      N,          N,          R(0,0),     R(0,0),     N},             //STATE 21: expr COMP var/expr
        {N,         N,      S(2),   S(3),   R(0,0), N,      N,      N,          SNA(18),    R(0,0),     R(0,0),     N},             //STATE 22: expr COMP id
