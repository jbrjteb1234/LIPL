...
state_table* get_expr_table(void){
    ...
    static state_table expr_table = {
        ...
        {N,         N,      2,      3,      A,      N,      10,     13,         SNA(18),    C,          20},        //STATE 1: ID
        ...
        {N,         N,      R(0,0), S(3),   R(0,0), N,      N,      N,          SNA(18),    R(0,0),     R(0,0)},    //STATE 6: expr +- ID
        {N,         N,      R(0,0), R(0,0), R(0,0), N,      N,      N,          SNA(18),    R(0,0),     R(0,0)},    //STATE 7: expr */ ID
        ...
        {N,         N,      S(2),   S(3),   R(0,0), N,      N,      N,          SNA(18),    C,          R(0,0)},    //STATE 22: expr COMP id
