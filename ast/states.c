...
typedef int numbers_table_type[NUM_TABLE_HEIGHT][WIDTH];
typedef int decl_table_type[DECL_TABLE_HEIGHT][WIDTH];
 ...
 */
const int operator_index_lookup[][6] = {
    {1, 1,  2,  2},         //numbers table
    {N, N,  N,  N,  N,  1}  //decl table
};

const int delimiter_index_lookup[][5] = {
    {3,3,N,N,N},    //numbers table
    {5,N,N,N,N}     //decl table
};

const int int_index_lookup[2] = {
    0,  //numbers table
    2   //decl table
};

const int identifier_index_lookup[2] = {
    0,  //numbers table
    0,  //decl table
};
...
void shift(table_iterator* iterator, token* current_token){
    ...
    //keep iterating through state table
    if(new_state >= 0){
