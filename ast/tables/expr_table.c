...
state_table* get_expr_table(void){
    ...
    static state_table expr_table = {
        ...
        {N,         N,      2,      3,      A,      N,      8,      10,         N,      C},         //STATE 1: ID
        ...
        {0,         0,      N,      N,      N,      N,      N,      N,          N,      N},         //STATE 14: ( 
        {N,         N,      N,      N,      N,      N,      N,      N,          N,      N},         //STATE 15: ( expr
        {N,         N,      N,      N,      N,      N,      N,      N,          N,      N},         //STATE 16: ( expr )
      
        {16,        N,      N,      N,      N,      N,      N,      N,          N,      17},        //STATE 17: expr
        {N,         N,      N,      N,      N,      N,      N,      N,          N,      N},         //STATE 18: 
        {N,         N,      N,      N,      A,      N,      N,      N,          N,      N},         //STATE 17: 
    };
    return &expr_table;
}